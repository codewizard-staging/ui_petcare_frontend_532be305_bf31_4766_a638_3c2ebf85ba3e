import PetCareCenterJsonConfig from "config/petcarecenter_product_information_form_fullform_config.json";
...
const MapItems = [
    { navpropname: "", uicomponent: "petcarecenter", expand: "Log", exclude: ['Logo'], func: Support.AddOrUpdatePetCareCenter }
]
