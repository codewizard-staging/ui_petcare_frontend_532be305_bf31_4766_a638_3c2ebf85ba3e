        ...
        <Box sx={{ width: '100%' }}>
            <ValidatorForm ref={form} onSubmit={handleSubmit}>
                    <Box style={{ display: 'flex', width: '100%' }}>
                        {props.controls.petcarecenter && <Box sx={{ width: "45%", margin: 2, boxShadow, borderRadius }}>
                            <RenderFormContols shadow={true} location="petcarecenter" mode={props.mode} title={"PetCareCenter"}
                                controls={props.controls.petcarecenter} options={props.options} onInputChange={OnInputChange} />
                        </Box>}
                    </Box>
            </ValidatorForm>
        </Box>
